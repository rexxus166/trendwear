    ...
    <div class="px-5 py-12 lg:px-12 max-w-7xl mx-auto min-h-[50vh]">
                    ...
                    <a href="{{ route('product.detail', $product->slug) }}" class="group cursor-pointer block">
                        ...
                        <div class="relative mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[3/4]">
                            ...
                            @if ($product->stock < 10 && $product->stock > 0)
                                <span
                                    class="absolute top-3 left-3 px-3 py-1 bg-red-500 text-white text-xs font-bold rounded-full shadow-sm">Limited</span>
                            @elseif($product->stock == 0)
                                <span
                                    class="absolute inset-0 bg-black/50 flex items-center justify-center text-white font-bold tracking-wider">SOLD
                                    OUT</span>
                            @endif
                        ...
                        <div>
                            <h4
                                ...
                                {{ $product->name }}</h4>
                            <p class="text-lg font-bold mt-1 text-gray-900">Rp
        ...
        @else
            <div class="flex flex-col items-center justify-center text-center py-20">
                ...
                <a href="{{ route('shop') }}"
                    class="px-6 py-3 bg-black text-white rounded-full font-bold hover:bg-gray-800 transition-colors">
                    Browse All Products
                </a>
            </div>
        @endif
