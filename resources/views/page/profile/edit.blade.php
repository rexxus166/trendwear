...
@section('content')
    <div x-data="{ showEditModal: false }" class="max-w-5xl mx-auto bg-white min-h-[80vh] relative lg:pt-8 lg:px-8">
        ...
        <div class="px-5 pb-12 lg:px-0 pt-6">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 mb-8 p-6 lg:p-10 bg-gradient-to-br from-black to-gray-800 rounded-3xl text-white shadow-xl relative overflow-hidden group">
                <div class="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-10 translate-x-10 blur-3xl"></div>
                
                <div class="w-20 h-20 lg:w-24 lg:h-24 rounded-full bg-white/20 p-1 flex items-center justify-center relative z-10 flex-shrink-0">
                    ...
                    <button class="absolute bottom-0 right-0 w-6 h-6 lg:w-8 lg:h-8 bg-white text-black rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform cursor-pointer z-20">
                ...
                <button @click="showEditModal = true" class="absolute top-4 right-4 md:static md:bg-white/10 md:px-4 md:py-2 md:rounded-lg md:hover:bg-white/20 transition-colors text-white text-sm font-medium flex items-center gap-2 cursor-pointer z-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-6 mb-8 lg:mb-12">
                ...
                <button class="flex items-center gap-4 p-4 lg:p-6 bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md hover:border-black/10 transition-all group text-left">
                    <div class="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center group-hover:bg-black group-hover:text-white transition-colors">
                        <svg class="w-6 h-6 text-gray-700 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-gray-100 pt-8 lg:pt-0 lg:border-none">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full flex items-center justify-center gap-2 p-4 lg:p-5 border-2 border-red-100 bg-red-50 rounded-2xl text-red-600 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all font-bold">
                ...
                <div x-show="showEditModal"
                    ...
                    <form method="post" action="{{ route('profile.update') }}" class="p-6">
                        ...
                        <div class="mt-8 flex items-center justify-end gap-3">
                            <button type="button" @click="showEditModal = false" class="px-5 py-2.5 rounded-xl text-gray-600 font-medium hover:bg-gray-100 transition-colors">
                                Cancel
                            </button>
                            <button type="submit" class="px-5 py-2.5 rounded-xl bg-black text-white font-bold hover:bg-gray-800 transition-transform active:scale-95 shadow-lg">
                                Save Changes
                            </button>
                        </div>
                    </form>
